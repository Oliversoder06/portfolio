            ...
            <div className='w-full flex flex-col lg:flex-row'>
                ...
                <form action="" className='w-full lg:w-[50%] h-[850px] flex flex-col gap-20 font-Monda items-center justify-center'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <label htmlFor="message" className='text-white font-Monda text-2xl cursor-none HoverCursor ml-2'>Message</label>
                        <textarea name="" id="message" placeholder='Enter your message...' className='w-[300px] xs2:w-[500px] h-[215px] rounded-md border-[1px] border-[#ffffff] bg-[rgba(7,7,7,0.2)] cursor-none HoverCursor pl-4 pt-3 text-white text-[20px] placeholder:text-[rgba(255,255,255,0.20)] focus:border-theme-blue outline-none'></textarea>
                    </div>
